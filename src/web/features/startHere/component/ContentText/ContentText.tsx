...
export default function ContentText() {
    return (
        <Flex className={styles.root} vertical>
            ...
            <p>I’ve encountered situations like boarding a plane with an expired license, navigating Thailand with a broken finger, and embarking on solo trips to places like <a href="https://mindthetravel.com/things-to-do-in-socotra/" target="_blank" className='bold'>Socotra</a>. While I prefer traveling alone due to being an introvert, I’ve also enjoyed group travels with 4 to 8 travel buddies.</p>
            ...
            <p>Learn from my mistakes to save both <a href="https://mindthetravel.com/best-tips-to-save-money-traveling-europe/" target='_blank' className='bold'>money</a> and time. Simply scroll down and click on the images below to delve into the content. Let’s explore the world</p>
        </Flex>
    )
}
