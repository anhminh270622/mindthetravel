...
export default function ContentAuthor() {
    return (
        <div>
            ...
            <p>
                If you are returning for a bunch of new travel tips, welcome back! My name is Ivan, and I’m really happy to see you here.</p>
            <p>
            ...
            <p>However, as time passed, I felt unsatisfied with my job, so I decided to quit.</p>
            <p>
